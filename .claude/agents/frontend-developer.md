...
description: Expert React/TypeScript frontend developer. Use for UI components, pages, state management, styling, i18n, and client-side logic in the SampleAspNetReactDockerApp.Client directory.
...
All frontend code lives in `SampleAspNetReactDockerApp.Client/`:
...
### Components
- Use Shadcn components from `src/components/ui/` — check existing ones before creating new
...
- Never mix — pick one per concern
...
- VideoSharing: `/api/videos/`, `/api/video-analysis/`
