...
namespace SharedEntities.Migrations
{
    ...
    [Migration("20250331130122_CreateAIContentTablesAndUserUploads")]
    partial class CreateAIContentTablesAndUserUploads
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FighterManager.Server.Models.AiAnalysisResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FighterManager.Server.Models.AiFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FighterManager.Server.Models.AppUserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 3, 31, 13, 1, 22, 77, DateTimeKind.Utc).AddTicks(3364));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 3, 31, 13, 1, 22, 77, DateTimeKind.Utc).AddTicks(3608));
            ...
            modelBuilder.Entity("FighterManager.Server.Models.Demonstration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FighterManager.Server.Models.HumanFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FighterManager.Server.Models.UploadedVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FighterManager.Server.Models.AiAnalysisResult", b =>
                {
                    b.HasOne("FighterManager.Server.Models.UploadedVideo", "Video")
                        .WithMany()
            ...
            modelBuilder.Entity("FighterManager.Server.Models.Demonstration", b =>
                {
                    b.HasOne("FighterManager.Server.Models.AppUserEntity", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("FighterManager.Server.Models.UploadedVideo", b =>
                {
                    b.HasOne("FighterManager.Server.Models.AppUserEntity", "AppUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
