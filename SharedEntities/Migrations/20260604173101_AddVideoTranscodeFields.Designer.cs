...
namespace SharedEntities.Migrations
{
    ...
    [Migration("20260604173101_AddVideoTranscodeFields")]
    partial class AddVideoTranscodeFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedEntities.Models.AiAnalysisResult", b =>
                {
                    ...
                    b.Property<string>("ContextCacheName")
                        .HasColumnType("text");

                    b.Property<string>("EliteTip")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SharedEntities.Models.CoachingReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SharedEntities.Models.CoachingStrength", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CoachingReportId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("TimestampEndMs")
                        .HasColumnType("integer");

                    b.Property<int?>("TimestampStartMs")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CoachingStrengths");
                });

            modelBuilder.Entity("SharedEntities.Models.CoachingWeakness", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ScoringImpact")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SharedEntities.Models.MatchEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ActionsDescription")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("StartTimestampMs")
                        .HasColumnType("integer");

                    b.Property<string>("SubmissionType")
                        .HasColumnType("text");

                    b.Property<string>("TechniqueCategory")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("AiAnalysisResultId", "SequenceIndex");
            ...
            modelBuilder.Entity("SharedEntities.Models.PrescribedDrill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SharedEntities.Models.VideoMetadata", b =>
                {
                    ...
                    b.Property<string>("PlaybackFilePath")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SharedEntities.Models.CoachingReport", b =>
                {
                    b.HasOne("SharedEntities.Models.AiAnalysisResult", "AiAnalysisResult")
                        ...
                        .HasForeignKey("SharedEntities.Models.CoachingReport", "AiAnalysisResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SharedEntities.Models.CoachingStrength", b =>
                {
                    b.HasOne("SharedEntities.Models.CoachingReport", "CoachingReport")
                        .WithMany("Strengths")
