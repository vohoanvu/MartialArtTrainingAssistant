...
import { TrainingSessionResponse, UpdateTrainingSessionRequest } from '@/types/global';
...
const TrainingSessionDetails: React.FC<ActionCellProps> = ({ sessionId }) => {
    const [sessionDetails, setSessionDetails] = useState<TrainingSessionResponse | null>(null);
    ...
    useEffect(() => {
        const fetchSessionDetails = async () => {
            try {
                const details = await getTrainingSessionDetails(sessionId, jwtToken!);
    ...
    const handleCheckIn = async () => {
        try {
            ...
            await updateTrainingSessionDetails(sessionId, updateSessionRequest, jwtToken!);
        ...
        <div className="container mx-auto max-w-lg p-8 shadow-lg rounded-lg">
            ...
            {sessionDetails && (
                <div className="border p-4 rounded-lg">
                    <p><strong>Instructor Name:</strong> {sessionDetails.instructorId}</p>
