...
export const handlers = [
  ...
  // VideoSharing: GET video feedback/analysis
  ...
  // VideoSharing: PATCH save video analysis result
  ...
  // VideoSharing: DELETE uploaded video
  ...
  // VideoSharing: POST upload sparring video file
